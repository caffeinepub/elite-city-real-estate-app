      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Explore our professionally designed and government-approved layout
            plan for Elite City Kalvakurthi
          </p>
        </div>
              ...
              <DialogContent className="max-w-[98vw] max-h-[98vh] p-4 bg-black/95">
                <div className="relative overflow-auto max-h-[90vh]">
                  <button
                    ...
                    className={`block w-full border-0 bg-transparent p-0 transition-transform duration-300 ${isZoomed ? "cursor-zoom-out scale-150" : "cursor-zoom-in"}`}
                  >
                    <img
                      src="/assets/Screenshot_20260222-232615.Adobe Acrobat.png"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="bg-elite-gold/10 border-elite-gold/30">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold text-elite-gold mb-2">
                  DTCP
                </div>
